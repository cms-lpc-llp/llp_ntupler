...
#/mnt/hadoop/store/group/phys_exotica/jmao/susy_llp/MSSM-1d-prod/n3n2-n1-hbb-hbb/n3n2-n1-hbb-hbb_mh200_pl100_ev100000/ntuple_RunIISummer16_n3n2-n1-hbb-hbb_mh200_pl100_ev100000_signal_aod_0Of33.root 
    ...
    for j,mm in enumerate(mh):
		...
		root_dir = '/mnt/hadoop/store/group/phys_exotica/jmao/susy_llp/fullsim/'+str1+'/'+m+'/'+str2+'/'
		root_name = 'ntuple_RunIIFall17_'+str2+'_fullsim_signal_aod_*.root'
		out_name = 'ntuple_RunIIFall17_'+str2+'_fullsim_signal_aod.root'
		...
		copy_dir = '/store/group/phys_exotica/jmao/susy_llp/fullsim/'+str1+'/'+m+'/'
