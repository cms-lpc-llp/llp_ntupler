...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(       
        ...
        #'file:/tmp/sixie/020e125e-bd5f-4fb7-ba16-ae33352f6527.root'
        'file:/afs/cern.ch/work/s/sixie/public/releases/run3/production/LLPSignalGeneration/Summer23/GENSIM/EL9/CMSSW_13_0_14/src/FEVTSIM.root'
        #'file:/tmp/sixie/28B4C642-E240-F145-B74D-807955B4D787.Winter20MC.root'
        )
)
...
process.ntuples = cms.EDAnalyzer('displacedJetMuon_ntupler',
    ...
    MuonCSCStripDigi = cms.InputTag("simMuonCSCDigis", "MuonCSCStripDigi"),
    MuonCSCWireDigi = cms.InputTag("simMuonCSCDigis", "MuonCSCWireDigi"),
